/*2.Develop a Servlet named AddProductServlet that accepts product details from a form (name, price, category), 
 * creates a Product Java Bean, and stores it in the session.
 */
